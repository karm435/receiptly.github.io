...
Please read these Terms of Use, including those set forth in the Privacy Policy ("Terms", "Terms of Use") carefully before using the ReceiptsCo application (the "App") made available by Karma Academy pty ltd ("us", "we", or "our").
